...
const newRoutes = (
    <Route path='/' component={App}>
        ...
        />
        <Route components={{ main: Sets, sidebar: NavSets }}>
        ...
        <Route components={{ main: Home, sidebar: NavHome }}>
            <Route
                path='favorites'
                component={Favorites}
                onEnter={requireAuth}
        ...
        <Route components={{ main: Events, sidebar: NavEvents }}>
