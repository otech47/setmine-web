		...
		return (
			<div className='flex-column' id='LandingHome'>
				...
				<div className='flex-row center'>
				    <a href='http://bit.ly/SetmineiOS' onClick={trackiOS} title='view on App Store' className='fa fa-apple fa-fw fa-4x wow fadeInLeft click'/>
				    <a href='http://bit.ly/SetmineAndroid' onClick={trackAndroid} title='view on Google Play'className='fa fa-android fa-fw fa-4x wow fadeInRight click'/>
				</div>
