		...
		<div id='About' className='flex-column'>
			...
			<section className='products flex-column'>
				...
				<div style={{marginBottom: '4rem'}}>
					<div className='flex-column product'>
						<img src='/public/images/setmusic/setmine-logo.png'/>
					...
					<div className='flex-column product'>
						<img src='/public/images/setmusic/setstory-logo.png'/>
			...
			<section className='team flex-column'>
				...
				<div className='flex-row' style={{padding: '0 10vw'}}>
					...
					<div className='flex-column member'>
						<img src='/public/images/setmusic/profileQuinn.png'/>
						<p>
							<h3>Quinn Pruitt</h3>
					...
					<div className='flex-column member'>
						<img src='/public/images/setmusic/profileChristian.png'/>
						<p>
					...
					<div className='flex-column member'>
						<img src='/public/images/setmusic/profileNafis.png'/>
						<p>
							<h3>Nafis Ahmed</h3>
					...
					<div className='flex-column member'>
						<img src='/public/images/setmusic/profileJohnny.jpg'/>
						<p>
							<h3>Johnny Gabos</h3>
					...
					<div className='flex-column member'>
						<img src='/public/images/setmusic/profileTurner.png'/>
						<p>
					...
					<div className='flex-column member'>
						<img src='/public/images/setmusic/profileBerny.jpg'/>
						<p>
